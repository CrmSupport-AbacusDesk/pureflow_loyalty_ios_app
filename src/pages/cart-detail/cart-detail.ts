...
export class CartDetailPage {
    ...
    addOrderItem()
    {
        ...
        this.dbService.onPostRequestDataFromApi({'item':this.order_item,'order_id':this.order_data.order_id,'order_data':this.order_data},"Order/add_order_item", this.dbService.rootUrlSfa).subscribe((result)=>{
            console.log(result);
            if(result == 'success')
            {
    ...
    place_order()
    {
        ...
        this.dbService.onPostRequestDataFromApi(this.order_data, "Order/add_order", this.dbService.rootUrlSfa).subscribe((result)=>
        {
            console.log(result);
    ...
    place_order_dealer()
    {
        ...
        this.dbService.onPostRequestDataFromApi(this.order_data,"Order/add_dealer_order", this.dbService.rootUrlSfa).subscribe((result)=>
        {
            console.log(result);
            if(result)
            {
